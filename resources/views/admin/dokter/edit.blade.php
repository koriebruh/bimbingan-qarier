            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <div class="max-w-2xl">
                    <section>
                        ...
                        <form class="mt-6 space-y-6" action="{{ route('admin.dokter.update', $user->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            {{-- Pilih Poli (jika role == dokter) --}}
                            @if ($user->role == 'dokter')
                                <div>
                                    <label for="poli_id" class="block text-sm font-medium text-gray-900">
                                        Poli
                                    </label>
                                    <div class="mt-2">
                                        <select id="poli_id" name="poli_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
