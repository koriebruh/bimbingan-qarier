            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form class="mt-6 space-y-6" id="formObat" action="{{ route('admin.obat.store') }}" method="POST">
                            @csrf

                            {{-- Nama Obat --}}
                            <div>
                                <label for="namaObat" class="block text-sm font-medium leading-6 text-gray-900">
                                    Nama Obat
                                </label>
                                <div class="mt-2">
                                    <input
                            ...
                            {{-- Kemasan --}}
                            <div>
                                <label for="kemasan" class="block text-sm font-medium leading-6 text-gray-900">
                                    Kemasan
                                </label>
                                <div class="mt-2">
                                    <input
